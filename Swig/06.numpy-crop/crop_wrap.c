...
#define SWIGTYPE_p_p_long swig_types[2]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__crop

#else
#  define SWIG_init    init_crop

#endif
#define SWIG_name    "_crop"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_crop(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:crop",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
    array1 = obj_to_array_contiguous_allow_conversion(obj0, NPY_LONG,
      &is_new_object1);
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "crop" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "crop" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = (int)(val7);
  {
    errno = 0;
    crop(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10);
  ...
  resultobj = SWIG_Py_Void();
  {
    ...
    PyObject* obj = PyArray_SimpleNewFromData(2, dims, NPY_LONG, (void*)(*arg8));
